...
/**
 * The general interface for computing diffs between two lists of elements of
 * type T.
 * 
...
public interface DiffAlgorithm<T> {
     ...
     * @param revised
     *            The revised sequence. Must not be {@code null}.
     * @return The patch representing the diff of the given sequences. Never
     *         {@code null}.
     */
